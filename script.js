...
let beats = {
  ...
  88: {
    beat: new Beat("./assets/drunk-bartender-preview-15s.mp3"),
    button: new Button("#FF3", 88),
  },
  67: {
    beat: new Beat("./assets/easy-preview-15s.mp3"),
    button: new Button("#FF3", 67),
  },
  86: {
    beat: new Beat("./assets/deep-red-preview-15s.mp3"),
    button: new Button("#FF3", 86),
  },
};
...
triggerBeat = (event) => {
  ...
  if (keyCode in beats) {
    ...
    keyPress.beat.play();
    // console.log(keyCode, "beat's workin!");
